    ...
    <div class="frame">
        ...
        <div id="page-wrapper" class="page-wrapper">
            ...
            <header id="header" class="header">
                ...
                <div class="container header-content">
                    <div class="main-title text-center">
                        <!-- Main-title -->
                        <h1 class="bold a-f mb-20"><span class="color">Karan</span>Luther<br> <!-- and Fun --> </h1>
                        <h3 class="bold a-f mb-20">Gameplay<span class="color"> Programmer</span> <br> <!-- and Fun --> </h3>
                        <div class="main-title-buttons a-f">
                            <!-- Button -->
                            <a href="#anchor-3" class="button button-1 margin-sm-bottom">Contact <i class="fas fa-chevron-right"></i></a>
                            <!-- Button -->
                    ...
                    <div id="anchor-1" class="grid grid-3">
                        ...
                        <div class="grid-item digital-art photography objects mb-30">
                            ...
                            <div class="project-card tilt md" data-tilt>
                                <!-- Case cover -->
                                <img src="img/portfolio/sm/1.png" alt="project">
                                <!-- Case description -->
                        ...
                        <div class="grid-item digital-art advertising mb-30">
                            ...
                            <div class="project-card tilt sm" data-tilt>
                                <!-- Case cover -->
                                <img src="img/portfolio/sm/2.png" alt="project">
                                <!-- Case description -->
                                <div class="project-title">
                                    <!-- Title -->
                        ...
                        <div class="grid-item art-direction mb-30">
                            ...
                            <div class="project-card tilt md" data-tilt>
                                <!-- Case cover -->
                                <img src="img/portfolio/sm/3.png" alt="project">
                                <!-- Case description -->
                                <div class="project-title">
                                    <!-- Title -->
                        ...
                        <div class="grid-item advertising photography mb-30">
                            ...
                            <div class="project-card tilt md" data-tilt>
                                <!-- Case cover -->
                                <img src="img/portfolio/sm/7.png" alt="project">
                                <!-- Case description -->
                                <div class="project-title">
                                    <!-- Title -->
                                    <h3 class="title bold">AIRAID</h3>
                                    <!-- More button -->
                        ...
                        <div class="grid-item art-direction digital-art photography mb-30">
                            ...
                            <div class="project-card tilt lg" data-tilt>
                                <!-- Case cover -->
                                <img src="img/portfolio/sm/4.png" alt="project">
                                <!-- Case description -->
                                <div class="project-title">
                                    <!-- Title -->
                        ...
                        <div class="grid-item photography digital-art mb-30">
                            ...
                            <div class="project-card tilt lg" data-tilt>
                                <!-- Case cover -->
                                <img src="img/portfolio/sm/6.png" alt="project">
                                <!-- Case description -->
                                <div class="project-title">
                                    <!-- Title -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 text-left text-md-right mb-30">
                            <!-- Button -->
                            <a href="#anchor-3" class="button button-1 ">Contact <i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
            </section>
			...
			<div id="MOVOLIT" style="display:none" class="modally-init" modally-max-width="800">
					...
					<div class="row">
						<div class="col-md-6">
							<h1 class="modal-title"style= "color:#fff;font-size: 30px;">MOVOLIT: Serve Before Self <p style="color:#fff">(2020)</p></h1>
							<h4 style="color:#fff">C#,Unity</h4>
							...
							<p style= "color:#fff;">Top-Down Architecture is used for an easy game flow.
								...
								2D Dynamic Lights and Shaders have been used in a real time environment.
							</p>
						</div>
						<div class="col-md-6">
						    ...
						    <div class="playstore">
						      <!--  <a href="https://itch.io/embed-upload/3247209?color=000000" target="_blank"><img src="./img/gplay.png"/></a> -->
						        <a href="https://itch.io/embed-upload/3247209?color=000000" class="button smooth-scroll">Play<i class="fas fa-chevron-right"></i></a>
						    </div>
			...
			<button  class="modally-close modally-close-button" onclick="pauseVid()">×</button>
					<div class="row">
						<div class="col-md-6">
							<h1 class="modal-title"style= "color:#fff;font-size: 30px;">GRAPPLU: The Beginnning<p style="color:#fff">(2020)</p></h1>
							<h5 style="color:#fff">C#,Unity</h5>
						...
						<div class="col-md-6">
						    <div class="playstore">
						        ...
						        <a href="https://itch.io/embed-upload/3247621?color=161212" class="button smooth-scroll">Play<i class="fas fa-chevron-right"></i></a>
						    </div>
			...
			<button  class="modally-close modally-close-button" onclick="pauseVid()">×</button>
					<div class="row">
						<div class="col-md-6">
							<h1 class="modal-title"style= "color:#fff;font-size: 30px;">UN-REPAIRABLE TOWER <p style="color:#fff">(2020)</p></h1>
							<h5 style="color:#fff">C#/Unity,Adobe Illustrartor</h5>
						...
						<div class="col-md-6">
						    ...
						    <div class="playstore">
						        <!--<a href="https://saigo.itch.io/the-unrepairable-tower" target="_blank"><img src="./img/gplay.png"/></a>-->
						        <a href="https://saigo.itch.io/the-unrepairable-tower" class="button smooth-scroll">Play<i class="fas fa-chevron-right"></i></a>
						    </div>
							<video  controls id="myVideo">
			...
			<button  class="modally-close modally-close-button" onclick="pauseVid()">×</button>
					<div class="row">
						<div class="col-md-6">
							<h1 class="modal-title"style= "color:#fff;font-size: 30px;">AIRAID <p style="color:#fff">(2019)</p></h1>
							<h5 style="color:#fff">C#, Unity</h5>
						...
						<div class="col-md-6">
						    ...
						    <div class="playstore">
						        <!--<a href="https://github.com/mattstg/AirRaid" target="_blank"><img src="./img/gplay.png"/></a>-->
						        <a href="https://github.com/mattstg/AirRaid" class="button smooth-scroll">Github<i class="fas fa-chevron-right"></i></a>
						    </div>
							<video  controls id="myVideo">
			...
			<button  class="modally-close modally-close-button" onclick="pauseVid()">×</button>
					<div class="row">
						<div class="col-md-6">
							<h1 class="modal-title"style= "color:#fff;font-size: 30px;"> SPINELESS <p style="color:#fff">A Blank Tale (2020)</p></h1>
							<h5 style="color:#fff">C#, Unity</h5>
						...
						<div class="col-md-6">
						    ...
						    <div class="playstore">
						       <!-- <a href="#" target="_blank"><img src="./img/gplay.png"/></a>-->
						        <a href="https://github.com/mattstg/VRISIEN" class="button smooth-scroll">Github<i class="fas fa-chevron-right"></i></a>
						    </div>
							<video  controls id="myVideo">
			...
			<button  class="modally-close modally-close-button" onclick="pauseVid()">×</button>
					<div class="row">
						<div class="col-md-6">
							<h1 class="modal-title"style= "color:#fff;font-size: 30px;">ASTROIDS<p style="color:#fff">(2019)</p></h1>
							<h5 style="color:#fff">C#/Unity</h5>
						...
						<div class="col-md-6">
						    <div class="playstore">
						        <a href="https://itch.io/embed-upload/3247734?color=484040" class="button smooth-scroll">Play<i class="fas fa-chevron-right"></i></a>
						    </div>
			...
			<button  class="modally-close modally-close-button" onclick="pauseVid()">×</button>
					<div class="row">
						<div class="col-md-6">
							<h1 class="modal-title"style= "color:#fff;font-size: 30px;">The Verge<p style="color:#fff">(2020)</p></h1>
							<h5 style="color:#fff">C#/Unity</h5>
            ...
            <section class="call-to-action" id="anchor-4" style="background-image: url(img/portfolio/lg/2.jpg); background-position: center">
                ...
                <div class="overlay-2 p-0-0-90">
                    <div class="container text-center">
                        <h2 class="bold mb-30"><br> <span class="color">FQA </span>Tester <!-- undertaken <span class="color">dream</span> <br> for entertainment or fun</h2> -->
                        <p class="light opas mb-30">Hi, I'm Karan. I have a Degree in computer Science from Lovely Professional University, and Video Game Programming Diploma from the ISI college, Montréal.
I have a good experience as a Game Developer. I would love to work and help you in projects.
I'm currently employed as a FQA Tester in Globalstep, but I'm always open for new and interesting oppertunities in the game industry. My specializational interests include: Gameplay Programming, Level Designing and QA Testing.


 </p>
                        <!-- Button -->
                        <a href="https://drive.google.com/file/d/1h6_sAa1xNuyrJ06b7E_5pQ-2xoWbxxjD/view?usp=sharing"  class="button button-1 new-page mb-30" ><i class="fas fa-file-pdf"></i>Resume</a>
						<a href="https://drive.google.com/file/d/1MYlgikVsglSNv8O5s615cLqLASurDjds/view?usp=sharing" class="button button-1  mb-30"><i class="fas fa-file-pdf"></i>Project</a>
                    </div>
                </div>
                ...
                <div class="container text-center text-md-left">
                    <div class="row text-center text-md-left footer-content mb-30">
                        <div class="col-12 col-md-12 col-lg-6 mb-30">
                            ...
                            <!-- Logo end -->
                            <!-- Footer text -->
                            <p class="light opas mb-30">Just to the right of you, You'll find a Contact Form send me a message and I'd be happy to hear from you!</p>
                            <!-- Phone -->
            ...
            <div class="get-in-touch">
                <div id="anchor-3" class="container">
                    <form id="form" class="contact-form row">
                        ...
                        <div class="form-field col-12">
                            <input id="message" name="text" class="input-text js-input" type="text" required>
                            <label class="label" for="message">Message</label>
                        </div>
                        <div class="form-field col-12 text-center">
                            <div class="submit-frame"><button class="submit hover button button-1" type="submit" value="Submit">Send message <i class="fas fa-chevron-right"></i></button></div>
                            <p class="success">Success <i class="fas fa-check"></i></p>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <div class="row copy" style="margin-top: -45px;">
                        <div class="col-12 col-lg-6 align-self-center mb-30">
                            ...
                            <ul class="social">
                                ...
                                <!-- Social link -->
                                <li><a href="https://twitter.com/karanluther?lang=en"><i class="fab fa-twitter"></i></a></li>
                               <!--  <li><a href="https://www.linkedin.com/in/karanluther/"><i class="fab fa-twitter"></i></a></li>
                                <li><a href="https://www.instagram.com/lutherkaran/"><i class="fab fa-twitter"></i></a></li> -->
                                ...
                                <!-- Social link -->
                                <li><a href="https://github.com/lutherkaran"><i class="fab fa-github"></i></a></li>
                            </ul>
                            <!-- Social icons end -->
                        </div>
                        <div class="col-12 col-lg-6 text-center text-md-left text-lg-right align-self-center mb-30">
                            <!-- Copyright -->
                            <p class="light"><span class="opas" ></span> <a class="color" href="#">No Copyrights©</a></p>
